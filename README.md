...
> **Reference deployment:** the organisation Cameroon's Business Development Team
> (the organisation BDT), replacing their Excel-based RFP eligibility screener.
> The codebase ships with the organisation BDT as the default org profile so a
...
├── requirements.txt
├── .streamlit/config.toml    # the organisation green branding
├── .github/workflows/
