...
with tab_settings:
    ...
    st.caption(
        ...
        "email digests. Defaults to **the organisation BDT** (the reference deployment) "
    ...
    org_name = oc1.text_input(
        ...
        help="Full name shown in page captions and the Report header. "
             "e.g. 'the organisation Cameroon — Business Development Team'.",
    )
    org_short = oc2.text_input(
        ...
        help="Compact label used in page titles, grant lead/sub defaults, "
             "and scan-log displays. e.g. 'the organisation BDT'.",
    )
