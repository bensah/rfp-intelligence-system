...
| `auto` | Rule-based scan (later + LLM in the Taadom phase) | **System-generated** after the hard gate; overridable in team meetings |
...
3. **LLM extraction (Taadom phase)** — replace remaining keyword fallbacks + improve robust crawl.
