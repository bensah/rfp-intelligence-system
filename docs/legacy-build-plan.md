...
> "Create the full folder structure for `chai-rfp-intelligence` as described in the build plan. Generate `requirements.txt`, `.streamlit/config.toml` with the organisation green branding (`#00703C` primary), and a placeholder `app.py` that requires login before showing any page."
