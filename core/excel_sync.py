...
Resolves the source workbook in this order:
  ...
  2. Local copy at the repo root (the organisation_Cameroon_RFP_Eligibility_Screener.xlsx)
...
def resolve_excel_path() -> dict:
    ...
    fallback = REPO_ROOT / "the organisation_Cameroon_RFP_Eligibility_Screener.xlsx"
    if fallback.exists():
