...
KEYWORD_STEMS: dict[str, list[str]] = {
    ...
    "Cardiovascular disease": ["cardiovascular", "cardiac", "cardio"],
    "Mental health":  ["mental"],
    "Outbreaks & epidemics": ["outbreak", "outbreaks", "epidemic", "pandemic"],
    "Non-communicable diseases": ["ncd", "ncds"],

    # ─── Cross-cutting themes ───
    "Antimicrobial resistance": ["amr", "antimicrobial"],
    "Vaccines & immunization": ["vaccine", "vaccines", "vaccination", "vaccinated",
                       "vaccinating", "immunization", "immunisation"],
    "Diagnostics": ["diagnosis", "diagnostic", "diagnostics", "diagnose",
    ...
    "Innovation":     ["innovation", "innovations", "innovative",
                       "innovate", "innovating"],
    "Digital health": ["digital", "digitization", "digitisation",
                       "digitize", "digitise"],
    "Artificial intelligence": ["ai", "artificial-intelligence",
                       "artificialintelligence"],
    "Data systems":   ["data", "dataset", "datasets"],
    "Analytics":      ["analytics", "analytic", "analysis", "analyses",
                       "analyse", "analyze", "analysing", "analyzing"],
    "Climate & health": ["climate", "climatic"],
    ...
    # ─── Populations ───
    "Maternal health": ["maternal", "maternity", "mother", "mothers"],
    "Child health": ["child", "children", "childhood", "pediatric",
                       "paediatric", "pediatrics", "paediatrics"],
    "Adolescent & youth": ["adolescent", "adolescents", "adolescence", "youth"],
    "Women":          ["women", "woman"],

    # ─── SRH ───
    "Reproductive health": ["reproductive", "reproduction"],
    "Sexual health":  ["sexual", "sexuality"],
    "Family planning": ["family", "families"],
    "Contraception":  ["contraception", "contraceptive", "contraceptives"],
    "Sexually transmitted infections": ["sti", "stis"],

    # ─── Health-system building blocks ───
    "Health financing": ["finance", "financing", "financed", "finances",
                       "financial"],
    "Health workforce": ["workforce", "personnel", "staffing"],
    "Supply chain":   ["supply", "supplies", "procurement"],
    "Pharmaceuticals": ["pharmaceutical", "pharmaceuticals", "pharma",
                       "medicine", "medicines", "drug", "drugs"],
    "Health insurance": ["insurance", "insure", "insured"],
