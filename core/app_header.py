...
Three placements, one helper (`render_app_header`):
  ...
  * MAIN CONTENT   — the organisation org logo + name, left-aligned strip + divider
  * GLOBAL CSS     — theme variables (the organisation green primary), card styles,
...
# the organisation brand green — used as the global accent. Pulled from the
...
THEME_PRIMARY = "#00703C"      # the organisation green
...
<style>
  /* ============================================================
     ...
     the organisation green primary, clean typography, consistent metric tiles.
     ============================================================ */
...
def render_app_header() -> None:
    ...
    and the the organisation org logo + name as a left-aligned strip at the top of
