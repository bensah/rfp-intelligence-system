...
def render_app_header() -> None:
    ...
    # NB: the non-super multi-tenant switcher moved to Settings → Accounts → Active tenant
    # (views.account_sections.render_active_tenant) — switching is now a deliberate Settings
    # action rather than an always-present header banner (owner 2026-08-31).
