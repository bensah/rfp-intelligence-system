...
CHAI = "28b17088-4d52-4546-85fb-5a14ba9ae22c"
...
class TenantIsolationTests(unittest.TestCase):
    ...
    def test_regular_user_scopes_to_own_tenant_via_jwt(self):
        _set_session(app_user={"role": "collaborator"}, tenant_id=CHAI, _tenant_jwt="jwt")
        c = sc.get_client()
        self.assertEqual(self._scope(c), CHAI)
    ...
    def test_regular_user_without_jwt_still_scoped(self):
        ...
        _set_session(app_user={"role": "collaborator"}, tenant_id=CHAI)  # no _tenant_jwt
        c = sc.get_client()
        self.assertEqual(self._scope(c), CHAI)
