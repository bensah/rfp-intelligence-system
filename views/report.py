...
if _show_sec("4"):
    ...
    if rfps_all.empty:
        ...
        # The bare acronym = the org's first word ("Example Country Team" → "the org"). A bare "the org"
        # rolls up to the full name; a qualified sibling ("Example Sibling Team", two tokens) does NOT.
        ...
        def _norm_org(raw) -> str:
            ...
            if _org_first and low == _org_first:
                return _org_full                   # bare acronym "the org" → "Example Country Team"
