...
#      canonical name. Subset rule handles "Avery" → "Drew Hall".
...
# bite us later if a Avery Stone joins alongside Drew Hall.
# ---------------------------------------------------------------------------
_NICKNAME_TO_FULL = {
...
def normalize_member_name(raw: str | None) -> str:
    ...
    for c in canonical_list:
        ...
        if not c_tokens:
            continue
        # Input ⊆ canonical (e.g. "Avery" ⊆ "Drew Hall") OR
