...
def render_manage_tenants(user: dict, sb) -> None:
    ...
    platform (a CHAI country / global team now; external orgs later). A management TABLE
    ...
    with st.form("add_tenant_form", clear_on_submit=True):
        ...
        t_name = c1.text_input(
            "New tenant name",
            placeholder="e.g. CHAI Zimbabwe, CHAI Global Malaria Team, Taadom Digital PLC")
        t_kind = c2.selectbox(
