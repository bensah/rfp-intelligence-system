...
This works identically for today's super-admin-provisioned users AND the future the second tenant
...
def render_onboarding(user: dict) -> None:
    ...
    st.caption(
        ...
        "(e.g. “the organisation Cameroon”, “the organisation Programme Team”). Start typing to find an "
        "existing one, or create yours if it isn't listed yet.")

    q = st.text_input("Your organization", key="onb_org_query",
                      placeholder="e.g. the organisation Cameroon")
