...
account owner from the source workbook). Two independent jobs:
  ...
  --fix-emails        Overwrite rfp_submissions.submitted_by_email for every
                      ...
                      cross-assignments (e.g. Barke Cisse had Shariffa's email).
...
TEAM: list[tuple[str, str]] = [
    ("Bernard Nsah",        "nbernard@clintonhealthaccess.org"),
    ("Tata Pepson",         "ptata@clintonhealthaccess.org"),
    ("Michael Budzi",       "mbudzi@clintonhealthaccess.org"),
    ("Shariffa Iliassu",    "siliassu@clintonhealthaccess.org"),
    ("Ornella Pokam",       "pornella@clintonhealthaccess.org"),
    ("Barke Cisse",         "bcisse.ic@clintonhealthaccess.org"),
    ("Abdoulaye Traore",    "atraore@clintonhealthaccess.org"),
    ("Lambi Joyce Lambif",  "jlambif@clintonhealthaccess.org"),
    ("Magloire Kuetche",    "ckuetchetakougang@clintonhealthaccess.org"),
    ("Anne Lutgarde",       "ayonkeu@clintonhealthaccess.org"),
    ("Yauba Saidu",         "ysaidu@clintonhealthaccess.org"),
]
