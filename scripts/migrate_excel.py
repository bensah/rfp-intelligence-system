...
def map_form1_row_by_header(row: list[Any], col_map: dict[str, int],
    ...
    return {
        ...
        "qualification": _txt(get("MUST 1 - Govt alignment")),
        "strategic_fit": _txt(get("MUST 2 - Strategic fit")),
        "capacity": _txt(get("MUST 3 - Implementable scope")),
        "geographic_fit": _txt(get("MUST 4 - Compliant")),
        "cofinancing": _txt(get("MUST 5 - Resourcing / timeline")),
        "funding_quality": _txt(get("PREFER 6 - Funding quality")),
        "funder_relationship": _txt(get("PREFER 7 - Monitorable results")),
        "competitiveness": _txt(get("PREFER 8 - Partnership advantage")),
        "bid_effort": _txt(get("PREFER 9 - Scale & sustainability")),
        ...
        "decision_note": _txt(get("Decision rationale (2-3 lines)",
