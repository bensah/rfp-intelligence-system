...
def map_form1_row_by_header(row: list[Any], col_map: dict[str, int],
    ...
    return {
        ...
        "geographic_scope": _multi(get("Geographic Scope", "Applicant Country")),
        ...
        "capacity": _txt(get("MUST 3 - Delivery capacity",
                             "MUST 3 - Implementable scope")),
        "geographic_fit": _txt(get("MUST 4 - Geographic fit", "MUST 4 - Compliant")),
        "cofinancing": _txt(get("MUST 5 - Cofinancing requirements",
