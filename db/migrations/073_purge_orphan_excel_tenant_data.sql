...
begin
  ...
  foreach _t in array _tables loop
    ...
    -- 1) Purge any excel rows tagged to Taadom (leaves the organisation's data intact).
...
-- =========================================================================
-- NOTE: even after this, a fresh tenant (Taadom) will still SEE the organisation's rows until
